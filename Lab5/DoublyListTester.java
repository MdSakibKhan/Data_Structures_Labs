public class DoublyListTester{
  public static void main(String [] args){
    System.out.println("\n/////  Test 01  /////");
    Object [] a1 = {new Integer(10),new Integer(20),new Integer(30),new Integer(40)};
